...
type PersonLinkProps = PersonNavigation &
  Readonly<{
    login: string;
    showAvatar: boolean;
  }>;
...
export function PersonLink({
  ...
  return (
    <a
      class="person-link inline-flex min-h-11 min-w-0 items-center gap-1.5 py-2 align-middle text-text-primary decoration-accent-link decoration-1 hover:text-accent-link-hover md:min-h-0 md:py-0"
