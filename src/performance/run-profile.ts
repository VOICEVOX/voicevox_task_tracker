...
async function main(): Promise<void> {
  ...
  process.stdout.write(
    [
      ...
      `codex_process_attempts=${profile.measurements.codex.processAttempts.toString()}`,
      `codex_process_attempt_limit=${profile.measurements.codex.configuredMaxProcessAttempts.toString()}`,
